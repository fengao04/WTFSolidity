...
这个代理合约比[第46讲](https://github.com/AmazingAng/WTFSolidity/blob/main/46_ProxyContract/readme.md)中的简单。它在`fallback()`函数中使用`delegatecall`将调用委托给逻辑合约，并通过内联汇编返回逻辑合约的返回值或错误信息。
