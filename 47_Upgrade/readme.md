...
这个代理合约比[第46讲](https://github.com/AmazingAng/WTFSolidity/blob/main/46_ProxyContract/readme.md)中的简单。它在`fallback()`函数中使用`delegatecall`，并通过`内联汇编`返回逻辑合约的返回值或回滚失败的调用。
